    ...
    <>
      ...
      <div className="lg:hidden fixed top-4 left-4 z-50">
        <button
          ...
          className="p-2.5 bg-white border border-slate-200 text-slate-700 hover:text-slate-900 shadow-xs transition-colors rounded-sm"
      ...
      >
        <div className="flex flex-col flex-1 overflow-y-auto">
          ...
          <div className="p-6 border-b border-slate-100">
            ...
            >
              ...
              <h2 className="font-sans font-semibold text-sm text-slate-900 tracking-tight group-hover:text-indigo-600 transition-colors mt-0.5">
                ...
                <div key={item.href} className="space-y-0.5">
                  <div className="flex items-center justify-between">
                    <Link
                      href={item.href}
                      onClick={() => setMobileOpen(false)}
                      className={`flex-1 flex items-center gap-3 px-3 py-2 text-xs font-medium tracking-wide rounded-sm transition-colors ${
                        isActive
                        ...
                        .map((child) => {
                          ...
                          return (
                            <Link
                              ...
                              href={child.href}
                              onClick={() => setMobileOpen(false)}
                              className={`block px-3 py-1.5 text-[11px] font-medium tracking-wide rounded-xs transition-colors ${
                                isChildActive
        ...
        <div className="p-4 border-t border-slate-100 bg-slate-50/50 space-y-2">
          <Link
            ...
            className="flex items-center justify-between px-3 py-2 text-xs font-medium text-slate-600 hover:text-slate-900 transition-colors border border-slate-200 bg-white rounded-sm hover:bg-slate-50"
          >
